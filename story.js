/**
 * Doki Doki Darwin Club - Game Script & Poem Minigame Data
 */
  ...
  chapters: [
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          sound: "punch",
          char: { name: "Darwin", img: "assets/char_darwin.jpg", pos: "center", shake: true }
        },
        {
          bg: "assets/bg_bakery.jpg",
          speaker: "Narrator",
        ...
        },
        {
          ...
          char: { name: "Daniel", img: "assets/char_daniel.jpg", pos: "center" }
        },
        {
          bg: "assets/bg_hospital.jpg",
          speaker: "Daniel",
          text: "Yo waddup lil cuh tf are you doing in my club domain you lil weak ass home skillet.",
          char: { name: "Daniel", img: "assets/char_daniel.jpg", pos: "center", bounce: true }
        },
        {
          bg: "assets/bg_hospital.jpg",
          speaker: "Darwin",
        ...
        },
        {
          ...
          char: { name: "Rafiki", img: "assets/char_rafiki.jpg", pos: "right", bounce: true }
        },
        {
          bg: "assets/bg_hospital.jpg",
          speaker: "Narrator",
        ...
        },
        {
          ...
          char: { name: "Darwin", img: "assets/char_darwin.jpg", pos: "left", shake: true }
        },
        {
          bg: "assets/bg_hospital.jpg",
          speaker: "Rafiki",
        ...
        },
        {
          ...
          char: { name: "Daniel", img: "assets/char_daniel.jpg", pos: "right" }
        },
        {
          bg: "assets/bg_bakery.jpg",
          speaker: "Daniel",
          text: "Wsg cuh. I hope you don't mind me master debating in your room.",
          char: { name: "Daniel", img: "assets/char_daniel.jpg", pos: "right", bounce: true }
        },
        {
          bg: "assets/bg_bakery.jpg",
          speaker: "Darwin",
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          sound: "screech",
          char: { name: "Darwin", img: "assets/char_darwin.jpg", pos: "center", bounce: true }
        },
        {
          bg: "assets/bg_bakery.jpg",
          speaker: "Narrator",
        ...
        },
        {
          ...
          sound: "victory",
          char: { name: "Spot", img: "assets/char_spot.jpg", pos: "right", bounce: true }
        },
        {
          bg: "assets/bg_bakery.jpg",
          speaker: "Darwin",
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          char: { name: "Clara", img: "assets/char_clara.jpg", pos: "right", bounce: true }
        },
        {
          bg: "assets/bg_kindergarten.jpg",
          speaker: "Narrator",
        ...
        },
        {
          ...
          char: { name: "Clara", img: "assets/char_clara.jpg", pos: "right" }
        },
        {
          bg: "assets/bg_clara_basement.jpg",
          speaker: "Darwin",
